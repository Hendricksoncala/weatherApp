    ...
    return (
        <section className="grid grid-cols-2 gap-4 mb-6 text-black">
            ...
            <div className="bg-purple-400 rounded-lg p-3">
                <p className="text-sm mb-1">Velocidad del viento</p>
            ...
            <div className="bg-purple-400 rounded-lg p-3">
                <p className="text-sm mb-1">Posibilidad de lluvia</p>
            ...
            {/* Presión */}
            <div className="bg-purple-400 rounded-lg p-3">
                <p className="text-sm mb-1">Presión</p>
            ...
            {/* Índice UV */}
            <div className="bg-purple-400 rounded-lg p-3">
                <p className="text-sm mb-1">Indicie UV</p>
